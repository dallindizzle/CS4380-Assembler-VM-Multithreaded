...
LDR R5 ZERO
CMP R4 R5
BRZ R4 endMainWhile2

LDA R0 ARR # Here we are storing input at CNT so threads can get it
LDR R1 CNT
ADD R0 R1
STR R3 R0
...
LDR R0 ZERO
LDR R1 CNT
printLoop2   LDA R2 ARR # Loop to print ARR values
            ADD R2 R0
            LDR R3 R2
            TRP 1
            ADI R0 4
...
NEWTHREAD MOV FP SP   # Here we are
ADI SP -8   # making
